<template>
    <div class=" main_container" id="promotions_container" v-if="dataloaded && promotions"> <!-- for some reason if you do not put an outer container div this component template will not render -->
