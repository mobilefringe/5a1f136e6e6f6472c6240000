            ...
            <form class="form-horizontal" action="form-submit" @submit.prevent="validateBeforeSubmit">
                <div class="form-group ">
                    ...
                    <div class="col-sm-4 col-xs-12" :class="{'has-error': errors.has('first_name')}">
                        ...
                        <input v-model="form_data.last_name" v-validate="'required|alpha_spaces'" class="form-control" :class="{'input': true}" name="first_name" type="text" placeholder="Last Name" data-vv-delay="1000">
