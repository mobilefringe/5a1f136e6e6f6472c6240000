                    ...
                    <form class="form-horizontal" action="form-submit" @submit.prevent="validateBeforeSubmit">
                      <div class="form-group ">
                        <div class="col-xs-6" :class="{'has-error': errors.has('name')}">
                          ...
                          <input v-model="user.name" v-validate="'required|alpha'" class="form-control" :class="{'input': true}" name="name" type="text"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-12" :class="{'has-error': errors.has('message')}">
                          ...
                          <!-- <input class="form-control" type="email" required="" placeholder="Email"> -->
                          <input v-model="user.message" v-validate="'required|alpha'" class="form-control" :class="{'input': true}" name="message" type="text"
