                    ...
                    <form class="form-horizontal" action="form-submit" @submit.prevent="validateBeforeSubmit">
                      <div class="form-group ">
                        <div class="col-xs-6" :class="{'has-error': errors.has('name')}">
                          ...
                          <input v-model="user.name" v-validate="'required|email'" class="form-control" :class="{'input': true}" name="name" type="text"
                      ...
                      <div class="form-group">
                        <div class="col-xs-6" :class="{'has-error': errors.has('phone')}">
                          ...
                          <!-- <input class="form-control" type="email" required="" placeholder="Email"> -->
                          <input v-model="user.phone" v-validate="'required|phone'" class="form-control" :class="{'input': true}" name="email" type="email"
                            placeholder="Email" data-vv-delay="1000">
                          <span v-show="errors.has('email')" class="form-control-feedback">{{ errors.first('email') }}</span>
                        </div>
                      </div>
