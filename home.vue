...
<script>
    define(["Vue", "vuex", "vue!today_hours", "vue!vue-slick","moment", "moment-timezone", "vue-moment", "vue-meta"], function(Vue, Vuex, TodayHoursComponent, slick ,moment, tz, VueMoment, Meta) {
