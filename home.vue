<template>
    <div class="row">
        ...
        <div class="content_container  position_relative" style="padding:0">
...
<script>
    define(["Vue", "vue!today_hours", "vue!vue-slick","moment", "moment-timezone", "vue-moment", "vue-meta"], function(Vue, TodayHoursComponent, slick ,moment, tz, VueMoment, Meta) {
