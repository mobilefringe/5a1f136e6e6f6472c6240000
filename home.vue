...
<script>
    define(["Vue", "vuex", "vue!today_hours", "vue!vue-slick","moment", "moment-timezone", "vue-moment", "vue-meta"], function(Vue, sVuex, TodayHoursComponent, slick ,moment, tz, VueMoment, Meta) {
