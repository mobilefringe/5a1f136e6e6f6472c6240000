        ...
        return Vue.component("stores-component", {
            ...
            methods: {
                ...
                filteredByCategory (category_id) {
                    ...
                    var y = _.filter(this.allStores, function(o) { console.log(o.categories, _.toNumber(category_id), _.indexOf(o.categories, _.toNumber(category_id)) ); return _.indexOf(o.categories, _.toNumber(category_id)) > -1; });
                    console.log(y);
                }
            },
            computed: {
