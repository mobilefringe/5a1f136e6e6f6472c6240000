    ...
    <div class="content_container main_container position_relative padding_top_20">
        <div class="map_container">
            <div id="map" class="hidden_phone">
                <img src="//codecloud.cdn.speedyrails.net/sites/5a1f136e6e6f6472c6240000/image/png/1511892740000/Canyon Crest - Map-01.png" class="" alt="" style="max-width:100%">
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div v-for="(stores,key) in storesByAlphaIndex">
                        ...
                        <div id="numbered_store_list_container" class="" v-for="store in stores">
