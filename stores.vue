        ...
        <div class="main_container">
            ...
            <div class="mobile_padding show_phone">
                ...
                <div class="select_container">
                    <v-select :value="selected_cat" :options="allMobileCategories" :placeholder="'Select By Categoty'" :searchable="false" :on-change="filteredByCategory" id="mobile_cat_list"></v-select> 
                </div>
                <div class="select_container">
            ...
            methods: {
                ...
                filteredByCategory (category_id) {
                    ...
                    if(category_id == "All"){
                        ...
                        var filtered = _.filter(this.allStores, function(o) {return _.indexOf(o.categories, _.toString(category_id)) > -1; });
