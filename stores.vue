    ...
    <div class="content_container  position_relative padding_top_20 storelist_container">
        ...
        <div class="main_container">
            ...
            <div class="mobile_padding show_phone">
                ...
                <!--</select>-->
                <v-select :value="selected_cat" :options="mobile_aphabet" :searchable="false" :placeholder="'Select Store A-Z'" :on-change="filteredByCategory" label="name" id="mobile_alpha_list"></v-select> 
                <v-select :options="mobile_aphabet" :searchable="false" :placeholder="'Select Store A-Z'" :on-change="filterStores" label="name" id="mobile_alpha_list"></v-select> 
            </div>
        ...
        return Vue.component("stores-component", {
            ...
            data: function() {
                return {
                    ...
                    selected_aplha : 'Select a Category'
                }
            },
            created (){
