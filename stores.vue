        ...
        return Vue.component("stores-component", {
            ...
            methods: {
                ...
                filteredByCategory (category_id) {
                    ...
                    var y = _.filter(this.allStores, function(o) { console.log(this); o.tempCat = this.findCategoryById (category_id); return _.indexOf(o.categories, _.toNumber(category_id)) > -1; });
