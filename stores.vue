        ...
        <div class="main_container">
            ...
            <div class="mobile_padding show_phone">
                ...
                <div class="select_container">
                    <v-select v-model="selected_cat" :options="allMobileCategories" :placeholder="'Select By Categoty'" :searchable="false" :on-change="filteredByCategory" id="mobile_cat_list"></v-select> 
                </div>
                <div class="select_container">
