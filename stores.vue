        ...
        <div class="main_container">
            ...
            <div class="mobile_padding show_phone">
                ...
                <div class="select_container">
                    <v-select :options="allMobileCategories" :placeholder="'Select By Categoty'" :searchable="false" :on-change="filterStores" id="mobile_cat_list"></v-select> 
                </div>
                <div class="select_container">
            ...
            <div class="row padding_bottom_50 padding_top_60">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row" v-if="processedStores">
                        <div class="col-md-12 store_col_1" id="storelist_container">
