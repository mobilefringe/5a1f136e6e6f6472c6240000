    ...
    <div class="content_container  position_relative padding_top_20 storelist_container">
        ...
        <div class="main_container">
            ...
            <div class="mobile_padding show_phone">
                ...
                <!--</select>-->
                <v-select v-model="selected_cat" :options="alphabet" :searchable="false" :placeholder="'Select Store A-Z'" :on-change="filterStores" label="name" id="mobile_alpha_list"></v-select> 
            </div>
