                    ...
                    <div class="col-md-6 col-sm-6 no_padding" v-for="promo in promotions" :data-cat="promo.cat_list">
                        <div class="promo_item cats_row is-table-row">
                            ...
                            <div class="col-md-7 padding_tb_20">
                                ...
                                <p>
                                    <span class="promo_dates sub_title" v-if="promo.is_closed"> Closed</span>
                                    <span class="promo_dates sub_title" v-else>{{promo.start_date | moment("MMM D", timezone)}} - {{promo.end_date | moment("MMM D", timezone)}}</span>{{promo.is_closed}}
                                </p>
