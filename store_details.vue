<template>
    <div class="row main_container" v-if="currentStore">
           ...
           <div class="promo_main_header sub_title">
                ...
                <div class="store_details_anchors pull-right">
                    ...
                    <a id="promo_anchor" href="#promos_main" v-if="promotions.length > 0">
                        ...
                        <img src="//codecloud.cdn.speedyrails.net/sites/5a1f136e6e6f6472c6240000/image/png/1512494363776/promo_icon.png" class="promo_icon" alt="">
                    </a>
                    <a id="job_anchor" href="#jobs_main" v-if="jobs.length > 0">
                        <tt>Jobs (<span>{{currentStore.total_published_jobs}}</span>)</tt>
                        <img src="//codecloud.cdn.speedyrails.net/sites/5a1f136e6e6f6472c6240000/image/png/1512494378989/jobs_icon.png" class="job_icon" alt="jobs icon">
                    </a>
                </div>
            </div>
            <div class="row" style="width:100%;">
                <div class="col-md-8 col-sm-8  col-xs-12">
                    <div id="map">
                        ...
                        <mapplic-map ref="mapplic_ref" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :maxscale= "5" :storelist="allStores" :floorlist="floorList" :svgWidth="2000" :svgHeight="2000" tooltiplabel="Info" :landmark=""></mapplic-map>
                    </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="side_stores">
                        <div class="store_header_btns animated_btn" v-if="currentStore.phone">
                            <a :href="'tel:'+currentStore.phone" >{{currentStore.phone}} <i class="fa fa-phone"></i></a>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12 promo_item" id="promos_main"  v-if="storeHours.length > 0 ">
...
<script> "vue!mapplic-map"], function(Vue, Vuex, MapplicComponent) {
