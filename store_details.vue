                        ...
                        <div class="promo_item cats_row ">
                            ...
                            <div class="col-md-7 padding_tb_20">
                                ...
                                <div class="text_center position_relative">
                                    <router-link :to="'/promotions/'+promo.slug" class="newsletter_btn animated_btn text_center" style="bottom: -4px;">Read More</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="jobs_container">
                    <div class="col=md-6 promo_item" v-for="job in jobs" :data-cat="job.cat_list">
                        <div class="col-md-12">
                            ...
                            <div class="text_center position_relative">
                                <router-link :to="'/jobs/'+job.slug" class="newsletter_btn animated_btn text_center"  style="bottom: -4px;">Read More</router-link>
                            </div>
                        </div>
                    </div>
                </div>
